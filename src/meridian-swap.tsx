...
import MeridianSwapForm from "./components/meridian/MeridianSwapForm";
...
export default function MeridianSwap() {
  ...
  async function authenticate() {
    try {
      setIsLoading(true);
      console.log("Starting authentication for Meridian Swap...");
  ...
  if (isLoading) {
    return <Detail isLoading markdown="# Loading Meridian Swap...\n\nPlease wait while we authenticate and load your wallet..." />;
  }
