...
import JouleRepayForm from "./components/joule/JouleRepayForm";
...
export default function JouleRepay() {
  ...
  async function authenticate() {
    try {
      setIsLoading(true);
      console.log("Starting authentication for Joule Repay...");
