...
import JouleWithdrawForm from "./components/joule/JouleWithdrawForm";
...
export default function JouleWithdraw() {
  ...
  async function authenticate() {
    try {
      setIsLoading(true);
      console.log("Starting authentication for Joule Withdraw...");
  ...
  if (isLoading) {
    return <Detail isLoading markdown="# Loading Joule Withdraw...\n\nPlease wait while we authenticate and load your wallet..." />;
  }
