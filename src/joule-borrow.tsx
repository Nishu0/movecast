...
import JouleBorrowForm from "./components/joule/JouleBorrowForm";
...
export default function JouleBorrow() {
  ...
  async function authenticate() {
    try {
      setIsLoading(true);
      console.log("Starting authentication for Joule Borrow...");
