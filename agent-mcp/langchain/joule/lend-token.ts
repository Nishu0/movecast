...
import { type AgentRuntime, parseJson } from "../../index"
...
export class JouleLendTokenTool extends Tool {
  ...
  if you want to lend MOVE, mint will be "0x1::aptos_coin::AptosCoin"
  if you want to lend token other than MOVE, you need to provide the mint of that specific token
